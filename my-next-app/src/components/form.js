            ...
            <div className="form1">
              <div className="fdiv1">
                <div className="border mg2">
                  <i className="fa-regular fa-user icons" />
                  <input type="text" name="f.name" placeholder="Name" />
                </div>
                <div className="border mg2">
                  <i className="fa-regular fa-envelope icons" />
                  <input type="email" name="email" placeholder="Email Address" />
                </div>
              </div>
              <div className="fdiv2">
                <div className="border mg mg2">
                  <i className="fa-solid fa-phone-volume icons" />
              ...
              <div className="border tarea mg2">
                <i className="fa-solid fa-pencil icons" />
                <textarea
                  name="comment"
                  id="comment"
